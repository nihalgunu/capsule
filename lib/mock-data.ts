...
export const MOCK_WORLD_STATE_10000BC: WorldState = {
  ...
  cities: [
    { id: "jericho", name: "Proto-Jericho", lat: 31.87, lng: 35.44, population: 300, brightness: 0.3, techLevel: 2, civilization: "Natufian", description: "One of the earliest permanent settlements, cultivating wild wheat and barley.", pros: "Fertile land, water access, crossroads of early trade routes", cons: "Vulnerable to invasion from all directions" },
    { id: "gobekli", name: "Göbekli Tepe", lat: 37.22, lng: 38.92, population: 200, brightness: 0.4, techLevel: 2, civilization: "Pre-Pottery Neolithic", description: "A mysterious ceremonial site where massive stone pillars are being erected.", pros: "Earliest monumental architecture — head start on organized labor and engineering", cons: "Isolated hilltop with limited farmland nearby" },
    { id: "catalhoyuk", name: "Proto-Çatalhöyük", lat: 37.67, lng: 32.83, population: 150, brightness: 0.2, techLevel: 2, civilization: "Anatolian", description: "Early farming communities experimenting with domesticated crops.", pros: "Dense proto-urban layout encourages innovation and social complexity", cons: "Landlocked with no river access for long-distance trade" },
    { id: "mehrgarh", name: "Mehrgarh", lat: 29.38, lng: 67.54, population: 100, brightness: 0.2, techLevel: 1, civilization: "Indus Precursor", description: "One of the earliest farming villages in South Asia.", pros: "Gateway to the Indus Valley — early metallurgy and dentistry", cons: "Arid borderlands, vulnerable to climate shifts" },
    { id: "hemudu", name: "Hemudu Culture", lat: 30.05, lng: 121.35, population: 80, brightness: 0.2, techLevel: 1, civilization: "Yangtze", description: "Early rice cultivation communities along the Yangtze River.", pros: "Rice surplus gives massive food advantage for population growth", cons: "Geographically isolated from other early civilizations" },
    { id: "nile_delta", name: "Nile Settlements", lat: 30.04, lng: 31.23, population: 120, brightness: 0.2, techLevel: 1, civilization: "Proto-Egyptian", description: "Fishing and farming communities along the fertile Nile floodplain.", pros: "Predictable flooding enables reliable agriculture and long-term planning", cons: "Desert on all sides limits expansion without massive effort" },
    { id: "zagros", name: "Zagros Foothills", lat: 35.5, lng: 46.0, population: 180, brightness: 0.25, techLevel: 2, civilization: "Proto-Sumerian", description: "Goat and sheep herders laying foundations for Mesopotamian civilization.", pros: "Animal domestication hub — wool, milk, and leather fuel early trade", cons: "Mountainous terrain slows communication between settlements" },
    { id: "ubaid", name: "Proto-Ubaid", lat: 30.96, lng: 46.10, population: 100, brightness: 0.2, techLevel: 1, civilization: "Mesopotamian", description: "Early communities in the marshlands between the Tigris and Euphrates.", pros: "Twin rivers provide irrigation potential unmatched anywhere on Earth", cons: "Flat, defenseless plains invite conflict from all sides" },
    { id: "sahara", name: "Green Sahara Camps", lat: 23.0, lng: 12.0, population: 60, brightness: 0.15, techLevel: 1, civilization: "Saharan", description: "The Sahara is still green — pastoral communities herd cattle across grasslands.", pros: "Vast green grasslands with room to expand in every direction", cons: "Climate is already shifting — desertification will devastate within millennia" },
    { id: "baltic", name: "Baltic Hunter Camps", lat: 55.0, lng: 23.0, population: 40, brightness: 0.1, techLevel: 1, civilization: "Mesolithic European", description: "Hunter-gatherer bands following reindeer herds as the ice retreats.", pros: "Abundant forests and coastline as ice retreats — untapped resources", cons: "Harsh winters and late agriculture adoption slow development" },
    { id: "doggerland", name: "Doggerland", lat: 54.0, lng: 2.0, population: 50, brightness: 0.1, techLevel: 1, civilization: "Mesolithic European", description: "A land bridge between Britain and Europe, soon to be flooded by rising seas.", pros: "Rich hunting grounds connecting two continents", cons: "Will be completely submerged by rising seas — existential risk" },
    { id: "clovis", name: "Clovis Culture", lat: 34.4, lng: -103.2, population: 30, brightness: 0.1, techLevel: 1, civilization: "Paleo-American", description: "Big-game hunters spreading across North America.", pros: "Entire continent of untouched resources with zero competition", cons: "Total isolation from Old World knowledge and trade networks" },
    { id: "peru_coast", name: "Peruvian Coast", lat: -12.0, lng: -77.0, population: 40, brightness: 0.1, techLevel: 1, civilization: "Andean Precursor", description: "Fishing communities along the Pacific coast beginning to settle.", pros: "Richest marine resources on Earth — protein surplus without farming", cons: "Andes barrier isolates coast from interior development" },
    { id: "jomon", name: "Jōmon Japan", lat: 35.7, lng: 139.7, population: 50, brightness: 0.15, techLevel: 1, civilization: "Jōmon", description: "Sophisticated hunter-gatherers creating the world's oldest pottery.", pros: "World's first pottery — technological innovation without agriculture", cons: "Island isolation limits contact with mainland advances" },
    { id: "australia", name: "Arnhem Land", lat: -12.5, lng: 133.0, population: 30, brightness: 0.1, techLevel: 1, civilization: "Aboriginal", description: "Ancient rock art traditions continue, songlines map the continent.", pros: "65,000 years of continuous culture — deepest knowledge traditions on Earth", cons: "Most isolated inhabited continent, no contact with other civilizations" },
  ],
  tradeRoutes: [
